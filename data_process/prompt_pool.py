...
!!! STRICT FORMAT RULES for <search>: !!!
    + You MUST replace LLM-Name with the EXACT name of a model selected from [Qwen/Qwen3-4B]. \
...
Only Qwen/Qwen3-4B is available in the routing pool, so you must never reference any other model name. \
...
Qwen/Qwen3-4B:\
Qwen/Qwen3-4B is a compact Qwen3-series instruction-tuned model optimized for routing experiments. It offers balanced reasoning, coding, and multilingual understanding while keeping compute costs low, making it ideal as both the base model and the sole callable specialist in this setup.\
