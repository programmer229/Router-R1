...
!!! STRICT FORMAT RULES for <search>: !!!
    + You MUST replace LLM-Name with the EXACT name of a model selected from [deepseek-ai/DeepSeek-R1-Distill-Qwen-32B]. \
...
Only deepseek-ai/DeepSeek-R1-Distill-Qwen-32B is available in the routing pool, so you must never reference any other model name. \
...
deepseek-ai/DeepSeek-R1-Distill-Qwen-32B is a 32B distilled reasoning model that blends DeepSeek-R1's long-chain thinking with competitive math and coding skills while remaining API friendly. Treat it as the primary specialist for complex, multi-step analysis and factual synthesis in this setup.\
